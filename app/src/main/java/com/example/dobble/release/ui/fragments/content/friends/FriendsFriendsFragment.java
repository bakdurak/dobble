...
import com.example.dobble.databinding.FriendsFriendsFragmentBinding;
...
public class FriendsFriendsFragment extends Fragment implements FriendsViewHolder.ActionHandler {
    private static final String ACTION_BTN_TEXT = "Remove";
    ...
    private FriendsFriendsFragmentBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FriendsFriendsFragmentBinding.inflate(inflater, container, false);
    ...
    private void removeFriendByUserIdUpdate(RxStatusDto<FriendDto> r) {
        ...
        if (!r.isSuccess()) {
            if (friendsViewHolder != null) {
                friendsViewHolder.setActionResultText(getString(R.string.friends_friends_remove_friend_error));
            }
            return;
        }

        if (friendsViewHolder != null) {
            friendsViewHolder.setActionResultText(getString(R.string.friends_friends_remove_friend_success));
        }
    ...
    public void onStart() {
        ...
        recyclerView = binding.friendsFriendsRecyclerView;
        ...
        adapter = new FriendsAdapter(this, this, friendsViewModel,
            ...
            FriendsAdapter.Type.FRIENDS, getResources(), fragmentComponent);
        adapter.setHasStableIds(true);
        recyclerView.setAdapter(adapter);
    }

    @Override
    public void handle(FriendsViewHolder friendsViewHolder) {
        friendsViewModel.removeFriendByUserId(friendsViewHolder.getUserId(),
            friendsViewHolder.getFriendResponse());
    }
